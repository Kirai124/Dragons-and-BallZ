...
export default class ItemDataModel extends SystemDataModel {
   ...
   * @type {string}
   */
  static ITEM_TOOLTIP_TEMPLATE = "systems/dragons-and-ballz/templates/items/parts/item-tooltip.hbs";
  ...
  prepareBaseData() {
    if ( this.parent.isEmbedded && this.parent.actor?.items.has(this.parent.id) ) {
      ...
      const sourceId = this.parent._stats.compendiumSource ?? this.parent.flags["dragons-and-ballz"]?.sourceId;
