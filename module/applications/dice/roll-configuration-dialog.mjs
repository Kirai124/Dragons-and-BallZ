...
export default class RollConfigurationDialog extends Dialog5e {
  ...
  static PARTS = {
    formulas: {
      template: "systems/dragons-and-ballz/templates/dice/roll-formulas.hbs"
    },
    configuration: {
      template: "systems/dragons-and-ballz/templates/dice/roll-configuration.hbs"
    },
    buttons: {
      template: "systems/dragons-and-ballz/templates/dice/roll-buttons.hbs"
    }
  };
  ...
  _identifyDiceTerms() {
    ...
    const identifyTerm = term => {
      ...
      for ( let i = 0; i < term.number; i++ ) dice.push({
        icon: `systems/dragons-and-ballz/icons/svg/dice/${term.denomination}.svg`,
